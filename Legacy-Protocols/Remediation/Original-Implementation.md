# Legacy Protocols: Original Implementation Guide

> **Note:** This document preserves the original content from the Legacy Protocols file. For the comprehensive, expanded documentation, see the [Legacy Protocols](../README.md) main section.

## Original Content: Monitoring and Detection Guide

This section contains the original KQL queries, PowerShell scripts, and Sentinel workbook that formed the foundation of legacy protocol detection.

### Quick Reference: Legacy Protocol List
...
## Automation Scripts: KQL Queries

### Tables Referenced

- **SigninLogs** - Azure AD sign-ins; includes Client/App/auth details
- **SecurityEvent** - Windows Security log mapped schema
- **WindowsEvent** - AMA agent; raw event data including channel & named fields

### Azure AD – Legacy Authentication Usage
...
### Windows – NTLM Operational Channel
...
1. Sentinel → Workbooks → Add → Edit → Advanced Editor → Gallery Template
2. Paste JSON → Apply

**Note:** If you already use Microsoft's official Insecure Protocols workbook, you can deploy that directly from GitHub; below is a compact variant tailored to your four key detections.
...
The content above has been significantly expanded in the new Legacy Protocols documentation:

- **Main Overview**: [Legacy Protocols README](../README.md)
- **Detailed Protocol Guides**: 
  - [NTLM](../Authentication/NTLM.md)
  - [SMBv1](../Authentication/SMBv1.md)
  - [Telnet](../Network-Protocols/Telnet.md)
  - And more...
- **Detection & Monitoring**: [Comprehensive Guide](../Detection-Monitoring/README.md)
- **Remediation**: [Phase-by-Phase Guide](./README.md)

---

**[← Back to Remediation Guide](./README.md)** | **[Main Legacy Protocols →](../README.md)**
